...
export async function createApp({
  ...
  example = 'https://github.com/henripal/create-dao/tree/main/template'
  ...
  console.log(`Creating a new DAO in ${chalk.green(root)}.`)
  console.log()
  ...
  console.log('    Compiles your contracts.')
  console.log()
  console.log(chalk.cyan(`  npx hardhat node`))
  console.log('    Deploy a local network.')
  console.log()
  console.log(chalk.cyan(`  npx hardhat run scripts/sample-script.js --network localhost`))
  console.log('    Deploy your contracts to the local network.')
  console.log()
  console.log(chalk.cyan(`  npm run dev`))
  console.log('    Start your DAO app.')
  console.log()
}
